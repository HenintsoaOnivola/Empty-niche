%From a community where there is empty niches, invaders are added into the community until it reaches an ESS and no more empty niches are detected. 
clear all;
...
log_sig_c_an_range=-2.5:0.0625:1;  %range for the width of competition kernel
log_sig_m_range=-3:0.0625:-0.5;  %range for the width of mutualistic kernel

log_sig_an=1;
sig_an=1;
sig_pl=sig_an;
resource_opt={'intra_guild','cross_guild'};
for resource_opt_ind=1:length(resource_opt)
    the_fold=strcat('Results_',resource_opt{resource_opt_ind},'/');
    dest=strcat('Results_invasion_',resource_opt{resource_opt_ind},'/');
    mkdir(dest);
    ...
    for log_sig_c_an=log_sig_c_an_range
        ...
        for log_sig_m=log_sig_m_range
            ...
            disp ([sig_an log_sig_c_an log_sig_m]);


            new_invasion=false;
            EN_value=detect_EN_function(the_fold,log_sig_an,log_sig_c_an,log_sig_m,rA,rP,const,h,x0,y0,kx,ky);
            EN_value=EN_value{1};

            if EN_value==0  %%when there is no empty niches, then copy the previous results from the eco-evolutionary dynamcis

                last_pop_an=read_last_line_to_array(strcat(the_fold,'animal_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                last_pop_pl=read_last_line_to_array(strcat(the_fold,'plant_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                last_tr_an=read_last_line_to_array(strcat(the_fold,'animal_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                last_tr_pl=read_last_line_to_array(strcat(the_fold,'plant_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                ...
                source_file=the_fold;

                copyfile(strcat(source_file,'time_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),dest);
                copyfile(strcat(source_file,'animal_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),dest);
                copyfile(strcat(source_file,'plant_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),dest);
                copyfile(strcat(source_file,'animal_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),dest);
                copyfile(strcat(source_file,'plant_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),dest);
                copyfile(strcat(source_file,'sepIndex_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),dest);

                clear_files(strcat(dest,'interval_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                write_into_files_W(strcat(dest,'interval_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),{the_inter});

            else %when there is empty niches, start the invasion at the positive fitness

                %read results from previous introductions
                pre_an_tr=read_data_into_cell(strcat(the_fold,'animal_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                pre_pl_tr=read_data_into_cell(strcat(the_fold,'plant_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                pre_an_ab=read_data_into_cell(strcat(the_fold,'animal_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                pre_pl_ab=read_data_into_cell(strcat(the_fold,'plant_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                pre_time=read_file_to_array(strcat(the_fold,'time_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                ...
                pre_separating_index=read_first_line_to_array(strcat(the_fold,'sepIndex_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));

                clear_files(strcat(dest,'sepIndex_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'ext_an_time_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'ext_pl_time_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'ext_an_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'ext_pl_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'introIndex_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                peaks_inter=localize_positive_fitness(last_pop_an,last_pop_pl,last_tr_an,last_tr_pl,rA,rP,h,const,log_sig_c_an,log_sig_c_pl,sig_an,sig_pl,x0,y0,kx,ky,log_sig_m);
                the_interval_an=peaks_inter{1};
                the_interval_pl=peaks_inter{2};
                ...
                while invade==true && count_introduction<max_introduction && repetition==false %&& oscillation==false
                    ...
                    the_inter=localize_positive_fitness(last_pop_an,last_pop_pl,last_tr_an,last_tr_pl,rA,rP,h,const,log_sig_c_an,log_sig_c_pl,sig_an,sig_pl,x0,y0,kx,ky,log_sig_m);
                    the_interval_an=the_inter{1};
                    the_interval_pl=the_inter{2};
                ...
                %write results into files if no more empty niche
                clear_files(strcat(dest,'time_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'animal_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'plant_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'animal_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'plant_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'sepIndex_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'introIndex_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));
                clear_files(strcat(dest,'interval_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'));

                write_into_files_W(strcat(dest,'time_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),time_plot);
                write_into_files_W(strcat(dest,'animal_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),trait_plot_an);
                write_into_files_W(strcat(dest,'plant_traits_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),trait_plot_pl);
                write_into_files_W(strcat(dest,'animal_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),pop_plot_an);
                write_into_files_W(strcat(dest,'plant_abundance_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),pop_plot_pl);
                write_into_files_W(strcat(dest,'sepIndex_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),separating_index);
                write_into_files_W(strcat(dest,'introIndex_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),intro_index);
                write_into_files_W(strcat(dest,'interval_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),{the_inter});
