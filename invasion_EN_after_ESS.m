...
for log_sig_c_an=log_sig_c_an_range
    ...
    for log_sig_m=log_sig_m_range
        ...
        the_fold=strcat('./Results_intra_guild/');
        dest='./Results_invasion_intra_guild/';
        % uncomment the following when the community optimizes cross-guild mutualistic benefits
%         the_fold=strcat('./Results_cross_guild/');
%         dest='./Results_invasion_cross_guild/';
        ...
        if EN_value==0  %%when there is no empty niches, then copy the previous results from the eco-evolutionary dynamcis
            ...
            write_into_files_W(strcat(dest,'interval_logsigA_',num2str(log_sig_an),'_logsigC',num2str(log_sig_c_an),'_logsigM',num2str(log_sig_m),'.dat'),{the_inter; the_peaks{1}; the_peaks{2} });
            ...
            while invade==true && count_introduction<max_introduction && repetition==false %&& oscillation==false
                ...
                the_interval_an=peaks_inter{2};
                the_interval_pl=peaks_inter{3};
                an_peaks=the_peaks{1};
                pl_peaks=the_peaks{2};
