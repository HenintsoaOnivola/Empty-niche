function res=simulation_different_sel_grad_threshold(sig_c_an,sig_m,opt_resource,lambda)
                ...
                if any(IE==1)
                    ...
                    if any (IE==2) 
                        ...
                        while(temp_total_time<=10^(6))
                            ...
                            tic;
                            [temp_time,temp_sol,temp_TE, temp_YE, temp_IE]=solve_eco_evo_subsequent_branching_lambda(initial_condition,rA,rP,h,const,sig_c_an,sig_c_pl,sig_an,sig_pl,x0,y0,kx,ky,sig_m,animal,plant,temporary_time,count_integrate,count_temporary,lambda);
