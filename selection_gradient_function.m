function sg=selection_gradient_function(IN,rA,rP,h,const,sig_c_an,sig_c_pl,sig_an,sig_pl,x0,y0,kx,ky,sig_m,animal,plant)
    ...
    sel_an=selection_gradient_an(x,A,P,benef_mat_an,benef_mat_an_pr);
    sel_pl=selection_gradient_pl(y,P,A,benef_mat_pl,benef_mat_pl_pr);
