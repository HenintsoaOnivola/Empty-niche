...
sig_pl=sig_an;
kx=200;
all_folders1={strcat('./Results_robustness/vary_kx=200_intra/'),strcat('./Results_robustness/vary_kx=200_cross/')};

%Ploting the first row (i.e. without invasion)
plot_names={'FigC4a','FigC4b'};
...
all_folders2={strcat('./Results_robustness/vary_kx=200_intra_invasion/'),strcat('./Results_robustness/vary_kx=200_cross_invasion/')};
plot_names={'FigC4c','FigC4d'};
