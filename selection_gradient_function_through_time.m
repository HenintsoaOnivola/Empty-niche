function all_selection=selection_gradient_function_through_time(an_ab,pl_ab,an_tr,pl_tr,rA,rP,h,const,sig_c_an,sig_c_pl,sig_an,sig_pl,x0,y0,kx,ky,sig_m)
