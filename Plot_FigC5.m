...
all_folders1={strcat('./Results_robustness/vary_x0=2.5_intra/'),strcat('./Results_robustness/vary_x0=2.5_cross/')};

%Ploting the first row (i.e. without invasion)
plot_names={'FigC5a','FigC5b'};
...
all_folders2={strcat('./Results_robustness/vary_x0=2.5_intra_invasion/'),strcat('./Results_robustness/vary_x0=2.5_cross_invasion/')};
plot_names={'FigC5c','FigC5d'};
