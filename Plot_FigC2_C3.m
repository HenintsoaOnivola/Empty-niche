...
const=0.05;
all_folders1={strcat('./Results_robustness/vary_const=0.05_intra/'),strcat('./Results_robustness/vary_const=0.05_cross/')};
%Ploting the first row (i.e. without invasion)
plot_names={'FigC2a','FigC2b'};
...
all_folders2={strcat('./Results_robustness/vary_const=0.05_intra_invasion/'),strcat('./Results_robustness/vary_const=0.05_cross_invasion/')};
plot_names={'FigC2c','FigC2d'};
...
% const=0.2;
% all_folders1={strcat('./Results_robustness/vary_const=0.2_intra/'),strcat('./Results_robustness/vary_const=0.2_cross/')};
% %Ploting the first row (i.e. without invasion)
% plot_names={'FigC3a','FigC3b'};
% for ii=1:length(plot_names)
%     the_fold=all_folders1{ii};
%     
%     % Initializing the matrix containing the number of species
...
% %Ploting the second row (i.e. with invasion)
% all_folders2={strcat('./Results_robustness/vary_const=0.2_intra_invasion/'),strcat('./Results_robustness/vary_const=0.2_cross_invasion/')};
% plot_names={'FigC3c','FigC3d'};
% for ii=1:length(all_folders2)
%     the_fold=all_folders2{ii}; 
%     introduction_matrix=zeros(length(log_sig_c_an_range)+1,length(log_sig_m_range)+1);
%     introduction_matrix(end,:)=NaN;
