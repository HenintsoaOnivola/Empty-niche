function [time, solution,TE,YE,IE]=solve_eco_evo_subsequent_branching(INI,rA,rP,h,const,sig_c_an,sig_c_pl,sig_an,sig_pl,x0,y0,kx,ky,sig_m,animal,plant,past_time,the_count_integrate,count_sys)
